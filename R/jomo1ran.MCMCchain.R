jomo1ran.MCMCchain <-
  function(Y, X=NULL, Z=NULL,clus, betap=NULL, up=NULL, covp=NULL, covu=NULL, Sp=NULL, Sup=NULL, nburn=500, a=NULL, meth="common") {
    ...
    if (meth=="common") {
      if (ncat==0 & ncon>0) {
        ...
        imp<-jomo1rancon.MCMCchain(Y_con, X, Z, clus, betap, up, covp, covu, Sp, Sup, nburn)
      }
      if (ncat>0 & ncon==0) {
        ...
        imp<-jomo1rancat.MCMCchain(Y_cat,Y_numcat, X, Z, clus, betap, up, covp, covu, Sp, Sup, nburn)
      }
      if (ncat>0 & ncon>0) {
    ...
    if (meth=="fixed") {
      if (ncat==0 & ncon>0) {
        ...
        if (is.null(Sp)) Sp=diag(1,ncol(Y))
        if (is.null(Sup)) Sup=diag(1,ncol(Y)*ncol(Z))
        imp<-jomo1ranconhr.MCMCchain(Y_con, X, Z, clus, betap, up, covp, covu, Sp, Sup, nburn,a=15000,meth="fixed")
      }
      if (ncat>0 & ncon==0) {
        ...
        if (is.null(Sp)) Sp=diag(1,ncol(covp))
        if (is.null(Sup)) Sup=diag(1,ncol(covu))
        imp<-jomo1rancathr.MCMCchain(Y_cat,Y_numcat, X, Z, clus, betap, up, covp, covu, Sp, Sup, nburn, a=15000, meth="fixed")
      }
      if (ncat>0 & ncon>0) {
        ...
        if (is.null(Sp)) Sp=diag(1,ncol(covp))
        if (is.null(Sup)) Sup=diag(1,ncol(covu))
        imp<-jomo1ranmixhr.MCMCchain(Y_con, Y_cat, Y_numcat, X, Z, clus, betap, up, covp, covu, Sp, Sup, nburn, a=15000, meth="fixed")
      }
    }
    if (meth=="random") {
      if (ncat==0 & ncon>0) {
        ...
        imp<-jomo1ranconhr.MCMCchain(Y_con, X, Z, clus, betap, up, covp, covu, Sp, Sup, nburn, a,meth="random")
      }
      if (ncat>0 & ncon==0) {
        ...
        if (is.null(Sup)) Sup=diag(1,ncol(covu))
        if (is.null(a)) a=ncol(covp)
        imp<-jomo1rancathr.MCMCchain(Y_cat,Y_numcat, X, Z, clus, betap, up, covp, covu, Sp, Sup, nburn, a, meth="random")
      }
      if (ncat>0 & ncon>0) {
        ...
        if (is.null(Sup)) Sup=diag(1,ncol(covu))
        if (is.null(a)) a=ncol(covp)
        imp<-jomo1ranmixhr.MCMCchain(Y_con, Y_cat, Y_numcat, X, Z, clus, betap, up, covp, covu, Sp, Sup, nburn, a, meth="random")
      }
    }
    return(imp)
  }
