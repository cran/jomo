jomo1ran.MCMCchain <-
  function(Y, X=NULL, Z=NULL,clus, beta.start=NULL, u.start=NULL, l1cov.start=NULL, l2cov.start=NULL, l1cov.prior=NULL, l2cov.prior=NULL, nburn=500, a=NULL, meth="common", output=1, out.iter=10) {
    ...
    if (meth=="common") {
      if (ncat==0 & ncon>0) {
        ...
        imp<-jomo1rancon.MCMCchain(Y.con, X, Z, clus, beta.start, u.start, l1cov.start, l2cov.start, l1cov.prior, l2cov.prior, nburn, output,out.iter)
      }
      if (ncat>0 & ncon==0) {
        ...
        imp<-jomo1rancat.MCMCchain(Y.cat,Y.numcat, X, Z, clus, beta.start, u.start, l1cov.start, l2cov.start, l1cov.prior, l2cov.prior, nburn, output, out.iter)
      }
      if (ncat>0 & ncon>0) {
        ...
        if (is.null(l1cov.prior)) l1cov.prior=diag(1,ncol(l1cov.start))
        if (is.null(l2cov.prior)) l2cov.prior=diag(1,ncol(l2cov.start))
        imp<-jomo1ranmix.MCMCchain(Y.con, Y.cat, Y.numcat, X, Z, clus, beta.start, u.start, l1cov.start, l2cov.start, l1cov.prior, l2cov.prior, nburn, output, out.iter)
      }
    }
    if (meth=="fixed") {
      if (ncat==0 & ncon>0) {
        ...
        if (is.null(l1cov.prior)) l1cov.prior=diag(1,ncol(Y))
        if (is.null(l2cov.prior)) l2cov.prior=diag(1,ncol(Y)*ncol(Z))
        imp<-jomo1ranconhr.MCMCchain(Y.con, X, Z, clus, beta.start, u.start, l1cov.start, l2cov.start, l1cov.prior, l2cov.prior, nburn,a=15000,meth="fixed", output, out.iter)
      }
      if (ncat>0 & ncon==0) {
        ...
        if (is.null(l1cov.prior)) l1cov.prior=diag(1,ncol(l1cov.start))
        if (is.null(l2cov.prior)) l2cov.prior=diag(1,ncol(l2cov.start))
        imp<-jomo1rancathr.MCMCchain(Y.cat,Y.numcat, X, Z, clus, beta.start, u.start, l1cov.start, l2cov.start, l1cov.prior, l2cov.prior, nburn, a=15000, meth="fixed", output, out.iter)
      }
      if (ncat>0 & ncon>0) {
        ...
        if (is.null(l1cov.prior)) l1cov.prior=diag(1,ncol(l1cov.start))
        if (is.null(l2cov.prior)) l2cov.prior=diag(1,ncol(l2cov.start))
        imp<-jomo1ranmixhr.MCMCchain(Y.con, Y.cat, Y.numcat, X, Z, clus, beta.start, u.start, l1cov.start, l2cov.start, l1cov.prior, l2cov.prior, nburn, a=15000, meth="fixed", output, out.iter)
      }
    }
    if (meth=="random") {
      if (ncat==0 & ncon>0) {
        ...
        imp<-jomo1ranconhr.MCMCchain(Y.con, X, Z, clus, beta.start, u.start, l1cov.start, l2cov.start, l1cov.prior, l2cov.prior, nburn, a,meth="random", output, out.iter)
      }
      if (ncat>0 & ncon==0) {
        ...
        if (is.null(l2cov.prior)) l2cov.prior=diag(1,ncol(l2cov.start))
        if (is.null(a)) a=ncol(l1cov.start)
        imp<-jomo1rancathr.MCMCchain(Y.cat,Y.numcat, X, Z, clus, beta.start, u.start, l1cov.start, l2cov.start, l1cov.prior, l2cov.prior, nburn, a, meth="random", output, out.iter)
      }
      if (ncat>0 & ncon>0) {
        ...
        if (is.null(l2cov.prior)) l2cov.prior=diag(1,ncol(l2cov.start))
        if (is.null(a)) a=ncol(l1cov.start)
        imp<-jomo1ranmixhr.MCMCchain(Y.con, Y.cat, Y.numcat, X, Z, clus, beta.start, u.start, l1cov.start, l2cov.start, l1cov.prior, l2cov.prior, nburn, a, meth="random", output, out.iter)
      }
    }
    return(imp)
  }
