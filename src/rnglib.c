...
*/
{
  ...
  {
    Rprintf ( "\n" );
    Rprintf ( "ADVANCE_STATE - Fatal error!\n" );
    Rprintf (  "  Input exponent K is out of bounds.\n" );
  }
/*
...
*/
  ...
  {
    Rprintf ( "\n" );
    Rprintf ( "ADVANCE_STATE - Note:\n" );
    Rprintf ( "  Initializing RNGLIB package.\n" );
    initialize ( );
  }
/*
...
# define G_MAX 32
  ...
  {
    Rprintf ( "\n" );
    Rprintf ( "CG_MEMORY - Fatal error!\n" );
    Rprintf ( "  Input generator index G is out of bounds.\n" );
  }
...
# define G_MAX 32
  ...
  else if ( 0 < i )
  {
    ...
    {
      Rprintf (  "\n" );
      Rprintf (  "CGN_MEMORY - Fatal error!\n" );
      Rprintf (  "  Input generator index G is out of bounds.\n" );
    }
...
*/
  ...
  {
    Rprintf (  "\n" );
    Rprintf (  "INIT_GENERATOR - Fatal error!\n" );
    Rprintf (  "  Input parameter T out of bounds.\n" );
...
*/
  ...
  Rprintf ( "\n" );
  Rprintf ( "INITIALIZE - Note:\n" );
  Rprintf ( "  The RNGLIB package has been initialized.\n" );
...
*/
{
  ...
  {
    Rprintf (  "\n" );
    Rprintf (  "SET_INITIAL_SEED - Fatal error!\n" );
    Rprintf ( "  Input parameter IG1 out of bounds.\n" );
  ...
  if ( ig2 < 1 || m2 <= ig2 )
  {
    Rprintf (  "\n" );
    Rprintf ( "SET_INITIAL_SEED - Fatal error!\n" );
    Rprintf (  "  Input parameter IG2 out of bounds.\n" );
...
*/
  if ( ! initialized_get ( ) )
  {
    Rprintf ( "\n" );
    Rprintf ( "SET_INITIAL_SEED - Fatal error!\n" );
    Rprintf ( "  The RNGLIB package has not been initialized.\n" );
...
*/
{
  ...
  {
    Rprintf (  "\n" );
    Rprintf (  "SET_SEED - Fatal error!\n" );
    Rprintf (  "  Input parameter CG1 out of bounds.\n" );
  ...
  if ( cg2 < 1 || m2 <= cg2 )
  {
    Rprintf (  "\n" );
    Rprintf (  "SET_SEED - Fatal error!\n" );
    Rprintf (  "  Input parameter CG2 out of bounds.\n" );
