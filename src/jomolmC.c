...
SEXP jomolmC(SEXP Ysub, SEXP Ysubimp, SEXP submod, SEXP ordersub, SEXP Y, SEXP Yimp, SEXP Yimp2, SEXP Yimpcat, SEXP X,SEXP betaY, SEXP betaYpost, SEXP beta, SEXP betapost, SEXP varY, SEXP varYpost, SEXP omega, SEXP omegapost, SEXP nstep, SEXP varYprior, SEXP Sp, SEXP Y_numcat, SEXP num_con, SEXP flagrng, SEXP MCMCchain){
	...
	for (j=0; j<IY; j++) {
		...
		if (nmiss>0) {
			...
			logLH=-0.5*mu2[0]*mu2[0]/REAL(varY)[0]-help6[0]/2;
					//	logLH=-0.5*mu2[0]*mu2[0]/REAL(varY)[0];
