...
for (i=0;i<ns;i++) {
	...
	//Rprintf("Y2=%f beta2=%f u2=%f \n Y2=%f beta2=%f u2=%f \n", imp2[0],REAL(beta2)[0],REAL(u)[Iu],imp2[1],REAL(beta2)[0],REAL(u)[1+Iu]);
