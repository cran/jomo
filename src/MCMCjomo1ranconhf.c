...
SEXP MCMCjomo1ranconhf(SEXP Y, SEXP Yimp, SEXP Yimp2, SEXP X, SEXP Z, SEXP clus, SEXP beta, SEXP u, SEXP betapost, SEXP upost, SEXP omega, SEXP omegapost, SEXP covu, SEXP covupost, SEXP nstep, SEXP Sp, SEXP Sup, SEXP flagrng){
...
for (i=0;i<ns;i++) {
	...
	for (c=0;c<nj;c++) {	
		...
		r8mat_poinv(JY, help,invomega);
		for (jj=1;jj<JY;jj++) for (tt=0;tt<jj;tt++) invomega[jj+JY*tt]=invomega[tt+JY*jj];
		wishart_sample(JY,clusnum[c],invomega,newomega2,help, omegaoo,omegaom,omegamm, 0);	
